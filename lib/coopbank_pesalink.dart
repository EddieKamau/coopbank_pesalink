...
class CoopPesalink {
  ...
  final String baseAccountNo; // coop bank account number that initiates the transactions
  ...
  Future<BankReponse> toMpesa({
    ...
    try {
      return await pesalinkProcessTransaction(toMpesaUrl, _header, _payload, applicationMode);
    } catch (e) {
      rethrow;
    }
  ...
  Future<BankReponse> toPesalinkAccount({
    ...
    try {
      return await pesalinkProcessTransaction(toPesaLinkAccountUrl, _header, _payload, applicationMode);
    } catch (e) {
      rethrow;
    }
  ...
  Future<BankReponse> accountBalance({
    ...
    try {
      return await pesalinkProcessTransaction(accountBalanceUrl, _header, _payload, applicationMode);
    } catch (e) {
      rethrow;
    }
  ...
  Future<BankReponse> accountValidation({
    ...
    try {
      return await pesalinkProcessTransaction(accountValidationUrl, _header, _payload, applicationMode);
    } catch (e) {
      rethrow;
    }
  ...
  Future<BankReponse> exchangerate({
    ...
    try {
      return await pesalinkProcessTransaction(exchangeRateUrl, _header, _payload, applicationMode);
    } catch (e) {
      rethrow;
    }
